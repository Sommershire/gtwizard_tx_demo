...
/* ------------------------------ PRBS-23 BEGIN ----------------------------- */
    logic [WID_PER_LANE*LINE_TX_LANES-1:0] prbs_64b;
    ...
    gtwizard_sync_prbs_prbs_any # (
        ...
        .NBITS      (WID_PER_LANE*LINE_TX_LANES)    // bus size 
    ) prbs_any_gen_inst (
        .RST        (!rst), // RST高位有效
        .CLK        (line_tx_clk_p),
        .DATA_IN    (0),
...
//////////////////////////////////////////////////////////////////////////////////
    ...
    for (m=0; m<LINE_TX_LANES/2+1; m++) begin
        for (n=0; n<WID_PER_LANE; n++) begin
            assign line_tx_data_to_gt_5g_sp[m*WID_PER_LANE+n] = line_tx_data_raw[m*WID_PER_LANE+n];
        end
    end
